...
const Header: React.FC = () => {
  ...
  const handleNav = (sectionId: string, label: string) => {
    ...
    <>
      ...
      >
        ...
        <motion.div className="top-bar-right" variants={containerVariants} initial="hidden" animate="visible">
          ...
          <motion.a className="LangugeSwitcher" variants={itemVariants}>
            <LanguageSwitcher />
          </motion.a>
        </motion.div>
      </motion.div>
        ...
        <div className="navbar-container">
          ...
          <nav className="nav-links">
            {[
              ...
              <motion.div key={link.label} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
                <motion.a
                  href={`#${link.sectionId}`}
                  className="nav-link"
                  onClick={(e) => {
                    e.preventDefault();
                    handleNav(link.sectionId, link.label);
                  }}
                >
            ...
            <div className="dropdown">
              <motion.button className="dropdown-trigger" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                More ▾
              </motion.button>
